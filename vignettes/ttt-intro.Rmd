...
themes may be added later.) Selecting the theme can be done using the option
`ttt.theme`:
...
Now, when we output our large table it looks like this:
...
```{r}
options(ttt.theme="default")  # Select the "default" theme
```
